...
if(is_post_request()) {
  ...
  if(isset($_POST['first_name'])) { $salesperson['first_name'] = htmlentities($_POST['first_name']); }
  if(isset($_POST['last_name'])) { $salesperson['last_name'] = htmlentities($_POST['last_name']); }
  if(isset($_POST['phone'])) { $salesperson['phone'] = htmlentities($_POST['phone']); }
  if(isset($_POST['email'])) { $salesperson['email'] = htmlentities($_POST['email']); }
